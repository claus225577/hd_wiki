...
tags: [deep-learning, speech, noise-reduction, dnn, hearing-aids, crn, transformer, mamba, generative-predictive, bayesian-counter-paradigm, llm-based-se, linguistic-hallucination, multimodal, audiovisual, single-step-generative-se, equilibrium-model, diffusion-aec, companion-phone, codec-evaluation, listening-effort, rir-encoder, room-aware-se, implicit-representations, c2d, real-paired-data, hallucination-quantification, generative-vs-discriminative]
---
