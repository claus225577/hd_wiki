...
created: 2026-04-15
updated: 2026-06-29
last_change: 2026-06-29 — Added **Beyond U-Net** (Pu & Scarpiniti, arXiv:2606.24745, 23 Jun 2026): a flow-matching SE model that **deletes U-Net skip connections** and aligns bottleneck + decoder outputs to clean-speech latent features from a **frozen Descript Audio Codec (DAC)**. Reasoning: skip paths leak noise-correlated low-level features encoder→decoder; foundation-codec latent provides a clean target. Datasets: WSJ0-CHiME3, VoiceBank-DEMAND. Result: competitive PESQ at **5 NFE** at inference (vs typical 20–50 NFE for flow/diffusion SE). Three HA implications: (1) the "small U-Net + harder pruning + better distillation" path is no longer the only viable 2028-chip bet — SE backbone is up for grabs again; (2) 5 NFE bends the curve toward HA-real-time generative SE — the question moves from *whether* to *when* and *on which neural accelerator*; (3) the **frozen-foundation-model-as-training-target** pattern (DAC as latent target) parallels Sabin et al. (arXiv:2606.26342) Whisper-based listener-rating predictor — domain-specific stacks built when nothing else existed are losing out to frozen foundation models with tiny heads. See source page [[../../sources/pu-scarpiniti-beyond-unet-flow-matching-se-2026]]. Previous change (2026-06-28) — Added FSC-Net (Chen et al., arXiv:2606.06962, Jun 2026): Fast Fourier Convolutions + progressive learning for speech bandwidth extension. Implicit global frequency-axis receptive field without parameter inflation; progressive bandwidth target schedule stabilises HF extrapolation. Relevant to the telephony / streaming chain into hearing aids and to dead-region handling for HF SNHL. Source page: [[../sources/arxiv-2606-06962-fsc-net-bandwidth-extension-jun-2026]]. Previous change (2026-06-25) — Added two June-2026 entries that reshape the SE design space. (1) **GSU-DBNet** (Meng, Jiang, Zhang, Zhou, Yin, arXiv:2606.23761, 22 Jun 2026): pure-SNN dual-branch SE with a new Gated Spiking Unit primitive used along temporal and frequency axes; PESQ 3.04 at 394K params, 4.5–10.6% of ANN-baseline param count — first arXiv pure-SNN SE result landing in a realistic HA parameter budget at competitive quality. Catalogued in new concept [[spiking-neural-networks-speech-enhancement]]; complements existing hybrid DBHN-Net (Fan et al., arXiv:2606.05911, 4 Jun 2026, TPAMI) — pure-SNN vs hybrid-SNN+ANN are the two architectural axes for the 2028-chip SNN-SE conversation. (2) **SE-AGCNet** (Zhang, Rao, Zhong, Chng, arXiv:2606.25959, 24 Jun 2026, accepted Interspeech 2026): joint end-to-end optimisation of SE + AGC with a loudness-aware loss (LUFS, short-term LUFS, LRA) and a paired data-generation pipeline (SE-AGC-DataGen); formally documents two cascade failure modes (AGC→SE amplifies noise; SE→AGC over-suppresses soft speech) that hearing-aid fitters have lived with for 25 years; the NR→WDRC cascade in HA processing is an artefact, joint training removes it. Catalogued in new concept [[joint-se-wdrc-end-to-end]]. Both papers narrow the gap between the HA processing chain (SE + WDRC + on-chip power budget) and what speech-enhancement research has been optimising for. Previous change (2026-06-23): Added Own-Voice Cancellation (OVC) entry: Østergaard, Neergaard Zahid, Ulbæk, Hansen Bagge, Falkær Olsen, Lindrup, arXiv:2606.23332, 22 Jun 2026 — introduces OVC as a first-class SE objective (cancel an enrolled speaker from noisy multi-speaker far-field audio while preserving other speech). TD-SpeakerBeam baseline with a Mamba-MinGRU masker variant and a linear-RNN auxiliary encoder; 2 ms algorithmic latency. Bridges existing hearing-aid OVP/OVD work (Phonak, Oticon, Signia, arXiv:2603.02724) to modern speaker-extraction architectures; reframes own-voice from a binary state-machine flag to a continuous SE conditioning signal. See new concept page [[own-voice-processing]]. Previous change (2026-06-18): Added QC-GAN (Yamauchi, Tamori, Sakai, Yamano, Nitta, arXiv:2606.18611, 17 Jun 2026) as the algebraic-weight-sharing Quaternion-Conformer GAN entry: full variant 0.89 M params / PESQ 3.48 on VoiceBank+DEMAND; compact variant 0.035 M params (35K) / PESQ 3.23 — first arXiv result this year living natively inside a hearing-aid memory budget (<40KB in INT8). Hamilton-product weight sharing collapses ~4 real-valued layers into 1 quaternion-valued layer with phase preserved by construction; MetricGAN training aligns optimization with perceptual metrics. Catalogued as the fifth on-chip lever in [[../syntheses/on-chip-hearing-ai-levers-june-2026]] (quaternion weight sharing as a separable axis on top of memory bandwidth, sparsity, inference steps, and frame rate). Earlier change (2026-06-17): Added BASENet as the band-adapted CRN entry — 3.55 PESQ / ~96% STOI / 0.83 M params / 7.3 GMACs on VoiceBank+DEMAND.
sources: [dnn-noise-reduction-intelligibility-2026.md, sub-millisecond-speech-enhancement-hearables-2025.md, multichannel-deep-speech-enhancement-ha-2024.md, speech-foundation-models-hearing-impaired-2024.md, ssl-loss-functions-hearing-aid-enhancement-2024.md, phonak-dnn-noise-reduction-clinical-trial-april-2026.md, deezer-44pct-ai-generated-audio-april-2026.md, wireless-hearables-programmable-speech-ai-accelerators-arxiv-2025.md, samsung-galaxy-s26-audio-eraser-realtime-2026.md, adobe-speechmatics-on-device-stt-april-2026.md, korhonen-natural-vs-dnn-hearing-aids-april-2026.md, dat-cftnet-ci-speech-enhancement-icassp-2026.md, tokense-mamba-ci-speech-enhancement-2026.md, gap-urgenet-urgent-challenge-icassp-2026.md, target-speaker-extraction-ultra-low-latency-2026.md, ssl-pretraining-robust-ha-speech-enhancement-2026.md, efficient-on-device-speech-enhancement-qat-2026.md, mdpi-speech-separation-survey-2026.md, spatial-magnifier-multichannel-se-arxiv-2026.md, ndf-plus-neural-directional-filtering-arxiv-2026.md, predictive-generative-drift-decomposition-arxiv-2026.md, aida-2-bayesian-generative-se-arxiv-2026.md, speaker-distance-estimation-reverberation-arxiv-2026.md, l3-se-linguistic-hallucination-llm-speech-enhancement-may-2026.md, gijbels-ecological-validity-fauot-mar-2026.md, driftse-equilibrium-se-arxiv-2026.md, diffvqe-diffusion-aec-arxiv-may-2026.md, tf-mlpnet-tiny-speech-separation-arxiv-2026.md, codec-intelligibility-se-behringer-arxiv-2026.md, arxiv-2606-05575-sbrf-schrodinger-bridge-jun-2026.md, arxiv-2606-05911-dbhn-net-snn-ann-fan-jun-2026.md, arxiv-2606-09557-rir-encoder-dereverb-khanagha-gerkmann-jun-2026.md, arxiv-2606-12328-halo-half-frame-rate-se-jun-2026.md, arxiv-2606-08580-gmapse-gmm-prior-matching-jun-2026.md, arxiv-2606-13109-c2d-microphone-projection-nakatani-jun-2026.md, arxiv-2606-02913-generative-vs-discriminative-se-jun-2026.md, uais-tetteh-se-techniques-hearing-aids-review-2026.md, arxiv-2606-09677-meco-meanflow-corrector-jun-2026.md, arxiv-2606-14175-hidvas-ku-leuven-jun-2026.md, arxiv-2606-12662-basenet-band-adapted-se-jun-2026.md, arxiv-2606-18611-qc-gan-quaternion-conformer-jun-2026.md, arxiv-2606-23332-ovc-own-voice-cancellation-jun-2026.md, arxiv-2606-23761-gsu-dbnet-neuromorphic-se-jun-2026.md, arxiv-2606-25959-se-agcnet-joint-se-agc-jun-2026.md, arxiv-2606-06962-fsc-net-bandwidth-extension-jun-2026.md, pu-scarpiniti-beyond-unet-flow-matching-se-2026.md]
related: [on-device-ml-hearing-aids.md, small-language-models-edge-ai.md, dnn-architectures-hearing-aids.md, auditory-attention-decoding.md, cochlear-implant-ai.md, ../entities/vcca-computational-audiology.md, state-space-models.md, ../comparisons/dnn-vs-natural-processing.md, mamba-architecture.md, active-noise-cancellation.md, eu-ai-act-medical-devices.md, probabilistic-generative-models-hearing-ai.md, llm-based-speech-enhancement.md, linguistic-hallucination-speech-enhancement.md, multimodal-hearing-assessment.md, companion-phone-speech-pipeline.md, listening-effort-evaluation.md, auracast-bluetooth-le-audio.md, room-aware-dereverberation.md, close-to-distant-microphone-projection.md, synthetic-data-for-hearing-ai.md, training-deployment-distribution-gap.md, own-voice-processing.md, differentiable-dsp.md, spiking-neural-networks-speech-enhancement.md, joint-se-wdrc-end-to-end.md]
tags: [deep-learning, speech, noise-reduction, dnn, hearing-aids, crn, transformer, mamba, generative-predictive, bayesian-counter-paradigm, llm-based-se, linguistic-hallucination, multimodal, audiovisual, single-step-generative-se, equilibrium-model, diffusion-aec, companion-phone, codec-evaluation, listening-effort, rir-encoder, room-aware-se, implicit-representations, c2d, real-paired-data, hallucination-quantification, generative-vs-discriminative, quaternion-conformer, metricgan, hamilton-product, algebraic-weight-sharing, own-voice-cancellation, ovc, td-speakerbeam, spiking-neural-network, snn, neuromorphic, gated-spiking-unit, gsu, joint-se-agc, wdrc, lufs, end-to-end-loudness]
---
...
## Algebraic Weight-Sharing — QC-GAN (Yamauchi et al., Jun 2026)
Yamauchi, Tamori, Sakai, Yamano & Nitta ([[../../sources/arxiv-2606-18611-qc-gan-quaternion-conformer-jun-2026]], arXiv:2606.18611, 17 Jun 2026) introduce **QC-GAN**, a parameter-efficient Quaternion Conformer GAN whose key inductive bias is **algebraic weight sharing via the Hamilton product**.

- **Generator:** real-valued conformer → Quaternion Conformer. One quaternion-valued layer encodes the information of ~4 real-valued layers under an algebraic constraint (the Hamilton product) baked in rather than learned. **Phase information is preserved by construction** — the part real-valued SE typically discards.
- **Training:** MetricGAN discriminator aligned with perceptual metrics (PESQ-adjacent), not waveform/spectrogram MSE.
- **Pipeline:** standard STFT input/output — drop-in compatible with downstream HA-DSP stages.

Headline (VoiceBank+DEMAND, validated on DNS-Challenge 3):
| Variant | Parameters | PESQ |
|---------|-----------|------|
| Full QC-GAN | **0.89 M** | **3.48** — comparable to SOTA at <50% the size |
| Compact QC-GAN | **0.035 M (35K)** | **3.23** — 25× parameter cut for 0.25 PESQ loss |

The compact variant is the **first arXiv result in 2026 living natively inside a hearing-aid memory budget**: 35K parameters in INT8 fits in <40KB, leaving SRAM for the rest of the HA pipeline (beamformer, AGC, classifier).

QC-GAN is the **fifth on-chip lever** in the June 2026 cluster catalogued in [[../syntheses/on-chip-hearing-ai-levers-june-2026]] — the algebraic-weight-sharing axis, orthogonal to memory bandwidth (Olalere FPGA), sparsity (DBHN-Net), inference steps (SB-RF), and frame rate (HALO). The Hamilton-product constraint forces a parameter reduction the model cannot trade away, unlike pruning (post-hoc) or quantization (precision-side). For stereo-mic HAs, the L/R complex spectrogram maps natively onto a quaternion — the compelling next-experiment QC-GAN does not directly evaluate.

## Own-Voice Cancellation — OVC (Østergaard et al., Jun 2026)
Østergaard, Neergaard Zahid, Ulbæk, Hansen Bagge, Falkær Olsen & Lindrup ([[../../sources/arxiv-2606-23332-ovc-own-voice-cancellation-jun-2026]], arXiv:2606.23332, 22 Jun 2026) introduce **Own-Voice Cancellation (OVC)** as a first-class far-field SE objective: given an enrolled-speaker embedding, **cancel** that speaker from noisy multi-speaker far-field audio while preserving everything else. This is the dual of target speaker extraction (TSE) — same enrolment, opposite output.

Architecture:
- **Baseline:** TD-SpeakerBeam (Delcroix et al., 2020) — the canonical TSE backbone; OVC inverts its objective.
...
- **Auxiliary encoder:** **Linear-RNN aux network** replaces the original ConvTasNet-based aux network used in TD-SpeakerBeam for producing the enrolled-voice embedding. Linear-RNN aux matches the linear-time complexity profile of the Mamba masker.
...
OVC bridges existing hearing-aid **OVP / OVD** work (Phonak Own Voice Processing, Oticon Own Voice Detection, Signia OVP, the March 2026 single-microphone OVD paper `arxiv-2603-02724-own-voice-detection-simulated-tfs`) to modern speaker-extraction architectures. The conceptual shift: own-voice goes from a **binary state-machine flag** (OVD → program branch in OVP) to a **continuous SE conditioning signal** (enrolled-voice embedding → continuous masker output).

This is the same move differentiable RIR encoders made for the room (Khanagha & Gerkmann, Jun 2026): expose an obvious axis the network was handling internally as an explicit input the rest of the pipeline can read. See the consolidated [[own-voice-processing]] concept page for the full OVD / OVP / OVC progression.

### Open questions
- Parameter / GMACs envelope (the paper emphasises latency; the on-chip footprint is the open number).
- Single-mic OVC for OTC / in-ear earbud form factors (the March 2026 OVD paper made the analogous move for detection).
- Stack-up with band-axis SE (BASENet), RIR-conditioning, and downstream DDSP-EQ — all four sit on independent axes and should compose.

## Band-Adapted CRN — BASENet (Martins Gomes & Capman, Jun 2026)
Martins Gomes & Capman ([[../../sources/arxiv-2606-12662-basenet-band-adapted-se-jun-2026]], arXiv:2606.12662, 10 Jun 2026) introduce **BASENet**, a CRN-family SE network whose key inductive bias is **the Bark-scale critical-band axis**. Three design points:
1. **Bark-scale critical-band partition** at the input — the same perceptual axis the cochlea uses.
2. **Scaled-capacity per-band encoder** — each band gets an encoder whose capacity is scaled to that band's critical-band density.
3. **Linear-complexity cross-band attention** — inter-band dependencies are mixed via attention over **frequency-pooled per-band representations**, not over the full TF grid. This is the operator that makes cross-band attention deployable at HA budgets.

Block stack: inverted residual blocks + dense connectivity + CRN backbone.

Headline (VoiceBank+DEMAND): **PESQ 3.55**, **STOI ~96%**, **0.83 M parameters**, **7.3 GMACs**. **Causal variant: PESQ 3.44** — surpasses several non-causal baselines, which is the deployment-critical result for any hearing-aid-style streaming pipeline.

BASENet is the **SE-mid-stage** entry in the June 2026 band-axis triangle: BiEAR at the periphery (Jun 5), BASENet at SE (Jun 10), FAConformer at the cortex (Jun 12) — three independent groups, eleven days, same operator (cross-band attention) on the same axis (perceptual critical bands). See synthesis [[../syntheses/band-axis-shared-coordinate-system-june-2026]] and the periphery / cortex counterparts under [[efferent-moc-feedback-hearing-ai]] and [[auditory-attention-decoding]].
...
### C2D — Real Paired Training Data via Close-to-Distant Microphone Projection (Nakatani et al., ICASSP 2026)
arXiv:2606.13109 (Nakatani, Ikeshita, Kamo, Delcroix, Araki — NTT Communication Science Laboratories, ICASSP 2026, submitted 11 Jun 2026):
- **Closes the simulation-to-reality gap on training data.** Standard hearing-aid SE training uses 12-22M *simulated* noisy-clean pairs (Oticon More 2021 → current flagships) because real paired data is unavailable. C2D enables real paired data via dual-microphone field recording — a close-talking mic + a distant mic array record the same scene.
- **Method: PMWF projection.** A Parametric Multichannel Wiener Filter variant estimates an optimal projection matrix that transforms close-mic input into the clean reference for the distant array while simultaneously performing denoising. The output is a noisy-clean pair sourced from a single real acoustic event.
- **Result on CHiME6:** outperforms Guided Source Separation (GSS, prior SOTA in that setting) under oracle diarization.
- **The lever moves from "bigger model + more synthetic data" to "better training-signal substrate."** Orthogonal to and stackable with every other SE frontier — latency-floor work (SB-RF, HALO, DriftSE, DiffVQE), architecture search (NDF+, Spatial-Magnifier), in-the-loop training (DFC-IL), and personalization (DAL, AIDA-2).
- For HA OEMs, the data-collection pathway is: body-worn close mic + ear-worn aid mics during real-world cohorts. Privacy and consent become the dominant non-engineering cost; the engineering pattern itself is unambiguous.
- See [[close-to-distant-microphone-projection]] (primary home), [[synthetic-data-for-hearing-ai]] (counter-paradigm), [[training-deployment-distribution-gap]] (broader framing).

### Generative vs Discriminative SE — First Empirical Hallucination Quantification (Saha Shetu, Habets, Brendel, Jun 2026)
arXiv:2606.02913 (Saha Shetu, Habets, Brendel — International Audio Laboratories Erlangen / Fraunhofer IIS, submitted 1 Jun 2026):
- **First study to quantify the hallucination cost of generative SE methods using ASR-derived metrics (WER + phoneme similarity) rather than perceptual surrogates (PESQ / STOI / HASPI).**
- **Discriminative wins on stationary intrusive noise and in-distribution conditions.**
- **Generative wins on non-stationary noise and unseen reverberation (OOD)** — the conditions a hearing-aid wearer actually encounters most of the time.
- **Generative methods hallucinate measurably more than discriminative ones**, and the gap is **invisible to PESQ / STOI / HASPI**. The May 2026 L3-SE paper *named* linguistic hallucination as a failure mode; this paper *quantifies* it on the diffusion-SE branch.
- Companion / inconvenient finding alongside SB-RF (one-step generative SE) — the latency-floor problem is cracking but the content-fidelity problem is not yet solved.
- **Class IIa implication:** the audiology evaluation stack does not currently measure the faithfulness-vs-quality tradeoff. A generative HA SE feature validated only on perceptual metrics may ship with worse word-fidelity than its predicate.
- **Hybrid is the obvious next move:** generative-when-OOD, discriminative-when-in-distribution, gated by on-device scene confidence — connects to the predictive-generative drift-decomposition thread (Richter et al., May 2026).
- See [[linguistic-hallucination-speech-enhancement]] (failure mode), [[../syntheses/speech-enhancement-evaluation-stack-cracks-may-2026]] (third crack quantified), [[probabilistic-generative-models-hearing-ai]] (paradigm benchmarking).
...
- [C2D Microphone Projection (Nakatani et al., ICASSP 2026)](../sources/arxiv-2606-13109-c2d-microphone-projection-nakatani-jun-2026.md) — arXiv:2606.13109; NTT; real paired SE training data via dual-mic + PMWF projection; outperforms Guided Source Separation on CHiME6
- [Generative vs Discriminative SE Comparison (Saha Shetu, Habets, Brendel, Jun 2026)](../sources/arxiv-2606-02913-generative-vs-discriminative-se-jun-2026.md) — arXiv:2606.02913; first empirical quantification of generative-SE hallucination via WER + phoneme similarity; Fraunhofer IIS / Erlangen
