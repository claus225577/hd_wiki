...
related: [on-device-ml-hearing-aids.md, speech-enhancement-neural-networks.md, dnn-architectures-hearing-aids.md, ../entities/vcca-computational-audiology.md, audio-reasoning-chain-of-thought.md, lalm-selective-auditory-attention.md, non-invasive-brain-to-speech.md, brain-aligned-speech-foundation-models.md, efferent-moc-feedback-hearing-ai.md]
...
Wang, He, Jia, Wang & Wu (Huazhong Univ. of Sci. & Tech.), arXiv:2606.14120, 12 June 2026. Three design changes on a Conformer trunk: (i) EEG is decomposed into multiple frequency bands, each encoded by an independent CNN-Transformer branch; (ii) a **Frequency-Aware Attention (FAA)** module treats band-wise features as tokens and models inter-band dependencies; (iii) **Band-wise Auxiliary Supervision (BAS)** prevents weakly contributing branches from being under-optimized during joint training — a direct antidote to dominant-band collapse. Reports **+4.9% accuracy** over the strongest of **12 baselines** on two public AAD datasets across three decision-window lengths. The abstract explicitly names AAD as a "key problem for neuro-steered hearing systems." Why it matters: short-window AAD accuracy is the latency-vs-correctness frontier for real-time neurosteering; band-wise decomposition is a smarter use of the EEG spectrum the device already has — no more electrodes, no more compute. Pairs naturally with **BiEAR** (arXiv:2606.06795, Jun 5 2026) as a **cortex-side band-axis** complement to BiEAR's **periphery-side band-axis** MOC controller: the same week, two papers operationalised frequency-band routing at opposite ends of the auditory hierarchy. The triangle closes with **BASENet** (arXiv:2606.12662, Jun 10 2026) at the SE mid-stage — three independent groups, eleven days, same cross-band-attention operator on the same Bark-scale critical-band axis. See [[efferent-moc-feedback-hearing-ai]] and synthesis [[../syntheses/band-axis-shared-coordinate-system-june-2026]].
